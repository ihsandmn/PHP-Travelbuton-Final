...
if (isset($_POST["simpan"])) {
  ...
  if (empty($error)) {
    if ($foto_name) {
      $direktori = "asset/adat";

      @unlink($direktori . "/$foto"); //delete data

      $foto_name = "adat_" . time() . "_" . $foto_name;
    ...
    if ($id != "") {
      $sql1 = "update adat_saya set nama = '$nama',foto='$foto_name',isi='$isi',maps='$maps',textmaps='$textmaps',youtube='$youtube',textyoutube='$textyoutube',tgl_update=now() where id = '$id'";
    } else {
      $sql1 = "insert into adat_saya(nama,foto,isi,youtube) values ('$nama','$foto_name','$isi','$maps','$textmaps','$youtube','$textyoutube')";
    }
...
<h1 style="text-align: center; padding: 2rem; font-weight: bold">Input Data Adat</h1>
<div class="mb-3 row">
  <a href="adat_saya.php">
...
<form action="" method="post" enctype="multipart/form-data">
  ...
  <div class="mb-3 row">
    ...
    <div class="col-sm-10">
      <?php if ($foto) {
        echo "<img src='asset/adat/$foto' style='max-height:100px;max-width:100px'/>";
      } ?>
