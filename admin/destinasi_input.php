...
if (isset($_POST["simpan"])) {
  ...
  if (empty($error)) {
    if ($foto_name) {
      $direktori = "asset/destinasi";

      @unlink($direktori . "/$foto"); //delete data

      $foto_name = "destinasi_" . time() . "_" . $foto_name;
    ...
    if ($id != "") {
      $sql1 = "update destinasi_saya set nama = '$nama',foto='$foto_name',isi='$isi',maps='$maps',textmaps='$textmaps',youtube='$youtube',textyoutube='$textyoutube',traveloka='$traveloka',tgl_update=now() where id = '$id'";
    } else {
      $sql1 = "insert into destinasi_saya(nama,foto,isi,maps,textmaps,youtube,textyoutube,traveloka) values ('$nama','$foto_name','$isi','$maps','$textmaps','$youtube','$textyoutube','$traveloka')";
    }
...
<h1 style="text-align: center; padding: 2rem; font-weight: bold">
  Input Data Destinasi
</h1>
<div class="mb-3 row">
  <a href="destinasi_saya.php">
...
<form action="" method="post" enctype="multipart/form-data">
  ...
  <div class="mb-3 row">
    ...
    <div class="col-sm-10">
      <?php if ($foto) {
        echo "<img src='asset/destinasi/$foto' style='max-height:100px;max-width:100px'/>";
      } ?>
  ...
  <div class="mb-3 row">
    <label for="traveloka" class="col-sm-2 col-form-label">Link Traveloka</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" id="traveloka" value="<?php echo $traveloka; ?>" name="traveloka" />
    </div>
  </div>
  <div class="mb-3 row">
