...
<body>
  ...
  <!-- Hero Start -->
  <section class="hero-makanan">
    <main class="content">
      <h1>Makanan</h1>
      <p>Kumpulan - Kumpulan Makanan di Pulau Buton</p>
    </main>
  </section>
  <!-- Hero End -->
  ...
  <!-- Menu Section Start -->
  <section class="menu">
    <h2><span>Rekomendasi</span> Makanan</h2>
    <p>
      Berikut adalah rekomendasi pilihan makanan untuk dirasakan di pulau
      buton
    </p>

    <!-- Konfigurasi MySql Start-->
    <?php
    $sql1 = "select * from makanan_saya order by id desc";
    ...
    while ($r1 = mysqli_fetch_array($q1)) { ?>
      ...
      <div class="row">
        <div class="menu-card">
          <a href="<?php echo buat_link_makanan($r1["id"]); ?>">
            <img src="<?php echo url_dasar() .
              "/admin/asset/makanan/" .
              makanan_foto($r1["id"]); ?>" alt="" class="menu-card-img" />
