...
<body>
  ...
  <?php if ($nama == "") {
    ...
    <section id="detail" class="detail">
      <h2><span>Tentang</span> Destinasi</h2>

      <div class="row-detail">
        <div class="detail-img">
          <img src="<?php echo url_dasar() .
            "/admin/asset/destinasi/" .
            destinasi_foto($r1["id"]); ?>" alt="Detail Destinasi" />
        </div>
        <div class="content">
          <h3>
            <?php echo $r1["nama"]; ?>
    ...
    <section class="youtube" id="youtube">
      <h2><span>Video</span> Destinasi</h2>
      <div class="row">
        <div class="content">
    ...
    <section class="peta" id="peta">
      <h2><span>Peta</span> Destinasi</h2>
      <div class="row">
    ...
    <section class="hotel" id="hotel">
      <h2><span>Penginapan</span> Destinasi</h2>
      <div class="row">
        <div class="content">
          <h3>Detail Penginapan Terdekat</h3>
          <p>
            Berikut adalah tombol untuk melihat dan membooking penginapan terdekat dengan rekomendasi destinasi dengan
            penyedia jasa Traveloka.
          </p>
          <div class="link-hotel">
            <a href="<?php echo $r1[
              "traveloka"
            ]; ?>" class="link-traveloka" target="_blank" rel="noopener noreferrer">Traveloka</a>
            <!-- <a href="<?php echo $r1[
              "tiketcom"
            ]; ?>" class="link-tiket" target="_blank" rel="noopener noreferrer">Tiket.com</a> -->
          </div>
        </div>
        <div class="hotel-img">
          <img src="<?php echo url_dasar(); ?>/asset/hotel.jpg" alt="Penginapan" />
        </div>
      </div>
    </section>
    <?php
